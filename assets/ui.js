  ...
  for(const t of tours){
    ...
    if(toursBubbleList){
      ...
      const detailParts = [
        ...
        `D3 G/K/NE/KB/A/VB: ${t.threeCustomersTotal || 0}/${t.threeCustomersBought || 0}/${t.threeCustomersNi || 0}/${t.threeCustomersKb || 0}/${t.threeCustomersCancelled || 0}/${t.threeCustomersPreordered || 0}`,
